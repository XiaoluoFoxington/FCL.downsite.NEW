...
const enUS = {
  ...
  about: {
    ...
    p4: '{about.devName}, the site owner, maintains this website and also provides the mirror 1 download source; developers like 晚梦 have made contributions that built this site up; {about.hahaName} and others provided additional mirror sources that greatly relieved bandwidth pressure; {about.ningName} provided this site\'s domain. In addition, we are grateful for the sponsorship, support, and encouragement of many kind friends!',
